...
public class RoleRightsOnlyExportTest extends base{
		...
		//Verify Only Export Roles Inquiry
		@Test()
		public void Verify_OnlyExport_Roles_Inquiry() {
		...
		//Verify Only Export Roles Prospect
		@Test()
		public void Verify_OnlyExport_Roles_Prospect() {
			SoftAssert softAssert=new SoftAssert();
		...
		//Verify Only Export Roles Project
		@Test()
		public void Verify_OnlyExport_Roles_Project() {
			SoftAssert softAssert=new SoftAssert();
		...
		//Verify Only Export Roles Booking
		@Test()
		public void Verify_OnlyExport_Roles_Booking() {
			SoftAssert softAssert=new SoftAssert();
		...
		//Verify Only Export Roles Customer
		@Test()
		public void Verify_OnlyExport_Roles_Customer() {
			SoftAssert softAssert=new SoftAssert();
			RoleRightsPage Customer = new RoleRightsPage(driver);
			Customer.getCustomer().click();
			//Customer Export To Excel Button
			boolean flag = false;
			try {
		...
		//Verify Only Export Roles Collection
		@Test()
		public void Verify_OnlyExport_Roles_Collection() {
			SoftAssert softAssert=new SoftAssert();
			RoleRightsPage Collection = new RoleRightsPage(driver);
			Collection.getcollection().click();
			//Collection Export To Excel Button
			boolean flag = false;
			try {
				WebElement ExportCustomer = Collection.getExportExcelCollecction();
				//Check if the element is displayed
				flag = ExportCustomer.isDisplayed();
			} catch (Exception e) {
				//Element not found, set flag to false
			...
			System.out.println("Is Export Collection visible: " + flag);
			softAssert.assertTrue(flag);	
			softAssert.assertAll();
		}
		
		//Verify Only Export Roles Receipt
		@Test()
		public void Verify_OnlyExport_Roles_Receipt() {
			SoftAssert softAssert=new SoftAssert();
		...
		//Verify Only View Export Employee
		@Test()
		public void Verify_OnlyExport_Roles_Employee() {
			SoftAssert softAssert=new SoftAssert();
		...
		//Verify Only Export Roles Document
		@Test()
		public void Verify_OnlyExport_Roles_Document() {
			SoftAssert softAssert=new SoftAssert();
