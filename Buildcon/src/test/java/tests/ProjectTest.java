...
public class ProjectTest extends base {
	...
	//Delete Project
	/*
	 * @Test() public void Delete_Project() throws InterruptedException {
	 * ProjectPage project = new ProjectPage(driver); project.getproject().click();
	 * project.getEdit(); project.getDeleteproject().click(); Thread.sleep(2000);
