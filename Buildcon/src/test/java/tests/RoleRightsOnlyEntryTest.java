...
public class RoleRightsOnlyEntryTest extends base {
	...
	@Test()
	public void Verify_OnlyEntryRoles_Inquiry() {
	...
	//Verify Only Entry Roles Prospect
	@Test()
	public void Verify_OnlyEntryRoles_Prospect() {
		SoftAssert softAssert=new SoftAssert();
	...
	//Verify Only Entry Roles Project
	@Test()
	public void Verify_OnlyEntryRoles_Project() {
		SoftAssert softAssert=new SoftAssert();
	...
	//Verify Only Entry Roles Booking
	@Test()
	...
	//Verify Only Entry Roles Receipt
	@Test()
	public void Verify_OnlyEntryRoles_Receipt() {
		SoftAssert softAssert=new SoftAssert();
	...
	//Verify Only Entry Roles Employee
	@Test()
	...
	//Verify Only Entry Roles Document
	@Test()
