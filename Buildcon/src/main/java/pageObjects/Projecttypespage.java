...
public class Projecttypespage {
	...
	By Configurationform = By.xpath(
			"/html/body/vex-root/vex-custom-layout/vex-layout/div/mat-sidenav-container/mat-sidenav[1]"
			+ "/div/vex-sidenav/div/vex-scrollbar/div[1]/div[2]/div/div/div/div[1]/vex-sidenav-item[12]/a");
	...
	By projecttypes = By.xpath(
			...
			+ "mat-sidenav-content/main/vex-configurations/div/div[2]/div/a[3]/div/mat-icon");
	...
	By Editprojecttypesrow = By.xpath(
			"/html/body/vex-root/vex-custom-layout/vex-layout/div/mat-sidenav-container/"
			+ "mat-sidenav-content/main/vex-project-type/div/div[2]/div/table/tbody/tr/td[3]/div/button[2]");
	...
	//Page object for changestatus confirmation dialog box
	...
	//Page object for delete click
	By deleteclick = By.xpath(
			"/html/body/vex-root/vex-custom-layout/vex-layout/div/mat-sidenav-container/"
			+ "mat-sidenav-content/main/vex-project-type/div/div[2]/div/table/tbody/tr[1]/td[3]/div/button[3]");
	public WebElement getdeleteclick() {
		base.failedElementName = "ProjectType-DeleteClick";
		return driver.findElement(deleteclick);
	}

	//Page object for delete click confirmation
	...
	By searchingprojecttypes = By.xpath(
			"/html/body/vex-root/vex-custom-layout/vex-layout/div/mat-sidenav-container/"
			+ "mat-sidenav-content/main/vex-project-type/div/div[1]/div[2]/div[1]/input");
	...
	//Page object for click searched button
	By clicksearchedbutton = By.xpath(
			"/html/body/vex-root/vex-custom-layout/vex-layout/div/mat-sidenav-container/"
			+ "mat-sidenav-content/main/vex-project-type/div/div[1]/div[2]/div[1]/mat-icon");
	...
	//Page object for click excel button project
	By clickexcelbuttonproject = By.xpath(
			"/html/body/vex-root/vex-custom-layout/vex-layout/div/mat-sidenav-container/"
			+ "mat-sidenav-content/main/vex-project-type/div/div[1]/div[2]/div[2]/button");
	...
	public void getActiveProject() {
		...
		driver.findElement(By.xpath("/html/body/div[4]/div[2]/div/mat-dialog-container/div/div/vex-project-type-add/"
				+ "div/form/mat-dialog-content/div[2]/div/mat-checkbox/div/div/input")).click();
	}
}